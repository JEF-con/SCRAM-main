...
def get_base_info(args):
    ...
    if args.defence == 'RLR':
        ...
        base_info = '{}_iid{}_{}_{}_{}_{}'.format(args.dataset,args.iid,
                args.model, args.defence, args.robustLR_threshold, current_time_str)
    else:
        # base_info = '{}_{}_{}_{}'.format(args.dataset,
        #             args.model, args.defence, int(time.time()))
        base_info = '{}__iid{}{}_{}_{}'.format(args.dataset,args.iid,
                    args.model, args.defence, current_time_str)
    if math.isclose(args.malicious, 0) == False:
